...
export default function SignIn() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen ">
      <div className="w-full max-w-md bg-input/30 p-2">
        <Badge>Pointmation</Badge>
        ...
        <Card className="w-full mt-2">
          ...
          <CardContent className="space-y-4">
            {error && (
              <Alert variant="destructive" className="mb-4">
                <AlertDescription>
                  ...
                  {error === "Callback" && "Error during authentication callback. Please try again."}
            ...
            <Button variant="outline" className="w-full flex items-center justify-center gap-2 h-12" onClick={handleSignIn} disabled={isLoading}>
              {isLoading ? (
